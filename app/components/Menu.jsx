...
const Menu = ({ page, setPage }) => {
    ...
    return (
        <nav className="fixed bottom-0 left-0 z-50 flex h-12 w-full items-center justify-around bg-gradient-to-t bg-primary from-primary to-primary-darker/50 transition-colors duration-300 md:hidden">
            <div
