    ...
    return (
        ...
        >
            <div className="flex gap-4 justify-center font-[800] items-center w-full">
                <Image
                    className="h-10 w-10 md:h-16 md:w-16 p-2.5 m-1 shadow-[0_0px_80px_rgba(255,255,255,1)] rounded-full dark:shadow-[0_0px_10px_rgba(0,0,0,0.5)]"
                    src={logo}
                    alt="radio world"
                    width={50}
                    height={50}
                ...
                <p className="text-dark">
                    RADIO <span className="text-white not-italic">Waves</span>
                </p>
            </div>
            <ThemeChanger />
        </header>
