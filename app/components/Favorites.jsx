        ...
        <section className="flex flex-col w-full gap-8 p-8">
            <div className="flex items-start">
                <Image
                    ...
                    height={75}
                />
                <h3 className="m-4 text-4xl font-semibold">Favorites</h3>
            </div>
            <ul className="flex flex-col gap-4 w-4/5 mx-auto">
                {favorites?.map((fav, index) => (
                    <li className="" key={index}>
                        <div className="bg-slate-400 w-full justify-around rounded-3xl flex items-center">
                            ...
                            <button className="m-4" onClick={() => removeFromFavorites(fav)}>
                                <Image
                                    src={removeIcon}
                                    alt="remove"
                                    width={30}
